"""
Command Line Interface for Age Standardized Rate Calculator.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="age-standardized-rate-calculator", description="Age Standardized Rate Calculator")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  AGE STANDARDIZED RATE CALCULATOR")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Age Standardized Rate Calculator Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Age Standardized Rate Calculator API server on http://{args.host}:{args.port}")
