"""
FastAPI REST API Server for Age Standardized Rate Calculator.
"""
...
app = FastAPI(
    title="Age Standardized Rate Calculator API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "age-standardized-rate-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
