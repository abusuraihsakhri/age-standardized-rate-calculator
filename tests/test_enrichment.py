"""
Automated Pytest for age-standardized-rate-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    CompetingEngine,
    BatchEngine,
    AgestandardizedratecalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = AgestandardizedratecalculatorEnrichmentSuite()
